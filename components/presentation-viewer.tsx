...
import { ChevronLeft, ChevronRight, ArrowLeft, Download, Share2 } from "lucide-react"
...
export function PresentationViewer({ presentation, onBackToForm }: PresentationViewerProps) {
  ...
  const { slides, title, date } = presentation
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="text-center">
          ...
          {date && <p className="text-gray-600 dark:text-gray-300">{date}</p>}
        </div>
